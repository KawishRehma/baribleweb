...
class Liveauction extends Component {
  ...
  render() {
    const hotauction = this.state.hotbiddata.map((bid) => {
      return (
        <Col>
          <Card className="cardmain11">
            <div key={bid.id}>
              <div className="cardhead11">
                <span className="something11">
                  <img className="cardhear-img1" src={bid.image1} />
                  <span className="tooltext11">Collection: Loot </span>
                </span>
                <span className="something11">
                  <img className="cardhear-img2" src={bid.image2} />
                  <span className="tooltext11">Creator: Watcher </span>
                </span>
                <Button className="cardhear-btn" variant="light">
                  {" "}
                  <FiMoreHorizontal />{" "}
                </Button>
              </div>
              ...
              <div className="card-parag">
                ...
                <Button className="card-btnp" variant="light">
                  {" "}
                  <BiHeart />{" "}
                </Button>
              </div>
    ...
    return (
      <Container>
        <p className="chart-two"> Live Auctions</p>
        <Row>{hotauction}</Row>
      </Container>
    );
  }
